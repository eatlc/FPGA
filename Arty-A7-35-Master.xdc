...
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { c_i }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { d_i }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { s1_i }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { s2_i }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
